...
## 1. O Projekcie i Marce

### 1.1 Czym jest produkt?

```
[Opisz w 2–3 zdaniach — dla kogo jest aplikacja i co robi]
```
...
```
[Opisz co klientowi nie odpowiada — konkretnie]

Przykłady:
- Nie chcę agresywnych kolorów (czerwień jako dominanta)
- Bez gradientów i "plastikowego" wyglądu
- Bez animacji które spowalniają korzystanie
```
...
## 7. Akceptacja Projektu Graficznego
...
**Zasada:** Akceptacja projektu graficznego przez Zamawiającego jest warunkiem rozpoczęcia implementacji UI. Zmiany graficzne po akceptacji i starcie implementacji traktowane są jako Change Request.
