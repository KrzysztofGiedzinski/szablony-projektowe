...
Wypełnij każdą sekcję tak dokładnie, jak potrafisz. Nie martw się, jeśli czegoś nie wiesz — zaznacz `[ ] Nie wiem / Do ustalenia` i omówimy to razem. Im więcej szczegółów, tym lepiej dopasujemy rozwiązanie do Twoich potrzeb i unikniemy niespodzianek w trakcie realizacji.

---

## 1. 🏢 Informacje o Firmie i Projekcie
...
> Opisz w 2–3 zdaniach, co robi Twoja firma, dla kogo i co ją wyróżnia na rynku.

```
[Wpisz tutaj]
```

### 1.3 Jaki problem chcesz rozwiązać tym projektem?

> Opisz konkretny ból lub potrzebę, którą ma zaspokoić aplikacja. Im bardziej konkretnie, tym lepiej.
...
Przykładowe zadania w aplikacji: _______________
```
...
## 5. 🏗️ Technologia i Infrastruktura
...
```
[Opisz tutaj — co masz teraz i co chcesz osiągnąć]
```

---

## 6. 🔐 Bezpieczeństwo i Prawo
...
## 8. 🔄 Po Wdrożeniu — Utrzymanie i Rozwój
...
### 10.1 Czy jest cokolwiek, o czym powinniśmy wiedzieć?

```
[Wpisz tutaj]
```

### 10.2 Jakie aplikacje / produkty Cię inspirują?
...
### 10.3 Czego zdecydowanie chcesz uniknąć?
...
```
Data spotkania: _______________
...
> 💡 **Złota zasada:** Wszystko, co nie jest zapisane — nie istnieje. Każda zmiana zakresu po podpisaniu umowy wymaga osobnego zgłoszenia (change request) i może wpłynąć na termin oraz budżet.